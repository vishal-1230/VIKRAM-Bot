    ...
    <AccordionRootComponent transition transitionTimeout={200}>
        {
          props.faqs.map((faq, index) => (
            <AccordionItem key={index} header={"0"+(index + 1) + " " + faq.header} headerStyle={props.headerStyle} contentStyle={props.contentStyle} showBorder={props.showBorder} expandButton={props.expandButon}>
              {faq.content}
            </AccordionItem>
          ))
        }
