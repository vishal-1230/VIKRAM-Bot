...
function SubscribeBox(props: {boxStyle?: string}) {
  return (
    <div className='flex flex-col xl:flex-row bg-white justify-between px-12 backdrop-blur-3xl max-w-fit self-center min-w-fit lg:min-w-0 py-14 rounded-lg gap-10' style={{boxShadow: "0px 2px 8px rgba(117, 131, 142, 0.08), 0px 20px 32px rgba(52, 60, 68, 0.16)"}}>
