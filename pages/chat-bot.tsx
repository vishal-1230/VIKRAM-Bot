...
function ChatBot() {
  ...
  return (
    <div className="bg-transparent">
      <MenuOpenOutlined className="md:!hidden invisible md:visible w-8 h-8 text-neutral-50 fill-neutral-50 cursor-pointer absolute top-6 z-[10000000] right-7" onClick={()=>{setShowSettingsInMobile(true)}} />
    <div
